...
namespace WYF.SqlParser
{
    public class ASTBuilder : GBaseVisitor<object>
    {
        ...
        public override object VisitQuerySpecification([NotNull] GParser.QuerySpecificationContext context)
        {
    ...
    protected override bool ShouldVisitNextChild(IRuleNode node, object currentResult)
    {
        ...
        public override object VisitColumnReference([NotNull] GParser.ColumnReferenceContext context)
        {
