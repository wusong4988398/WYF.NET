...
namespace WYF
{
    ...
    public interface ICache
    {
        ...
        void Remove(string type, params string[] fields);

        void Put(string type, Dictionary<string, string> keyValues, int timeoutSeconds);

        void Put(string type, Dictionary<string, string> keyValues, TimeSpan timeSpan);

        void Put(string type, string key, string value, TimeSpan timeSpan);
